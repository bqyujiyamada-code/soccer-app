        ...
        <div className="space-y-6">
          {matches.length === 0 ? (
            ...
            matches.map((match) => {
              ...
              return (
                <div key={match.id} className="bg-white text-slate-900 rounded-[2rem] overflow-hidden shadow-2xl">
                  {/* 画像エリア */}
                  <div className="h-44 w-full relative">
                    <img src={displayImageUrl} className="w-full h-full object-cover" alt="match scene" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent"></div>
                    <div className="absolute top-4 left-4 bg-blue-600 text-white text-[10px] font-black px-3 py-1 rounded-full shadow-lg">
